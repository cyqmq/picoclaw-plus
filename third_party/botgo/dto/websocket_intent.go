...
const (
	...
	// - OPEN_FORUM_REPLY_DELETE      // 当用户回复评论时
	IntentOpenForum Intent = 1 << 18

	// IntentAudioOrLiveChannelMember 音视频/直播子频道成员进出事件
	// - AUDIO_OR_LIVE_CHANNEL_MEMBER_ENTER // 用户进入音视频/直播子频道时
	// - AUDIO_OR_LIVE_CHANNEL_MEMBER_EXIT  // 用户退出音视频/直播子频道时
	IntentAudioOrLiveChannelMember Intent = 1 << 19
